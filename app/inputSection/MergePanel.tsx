...
export default function MergePanel({
  ...
  async function handleRunInput() {
    ...
    const response = await mergeAction(input, existingNotes, gptModelName);
  ...
  return (
    <>
      <NoteField
        ...
        placeholder="Merge in new information while reorganizing and de-duplicating..."
        sx={{ marginTop: 1 }}
        value={input}
      />
